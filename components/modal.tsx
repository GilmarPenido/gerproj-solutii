...
export default function Modal({ children, isOpen, setOpenModal, title}: {children: React.ReactNode, isOpen: boolean, setOpenModal:  Dispatch<SetStateAction<boolean>>, title: string}) {
    ...
    <>
      {showModal ? (
        <>
          ...
          >
            <div className="relative w-auto my-6 mx-auto max-w-4xl w-[95%]">
              {/*content*/}
